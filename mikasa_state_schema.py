...
Must never import mikasa_state (cycle); shared constants live in hermes_state_common.
"""
...
class SessionSchemaMixin:
    ...
    def _parse_schema_columns(schema_sql: str) -> Dict[str, Dict[str, str]]:
        ...
        with contextlib.suppress(Exception):  # missing/corrupt cache → recompute below
            # Late import: resolves a test-patched mikasa_constants.get_mikasa_home.
            from mikasa_constants import get_mikasa_home as _home
    ...
    def _backfill_gateway_metadata_from_sessions_json(self, cursor: sqlite3.Cursor) -> None:
        ...
        sessions_file = get_mikasa_home() / "sessions" / "sessions.json"
