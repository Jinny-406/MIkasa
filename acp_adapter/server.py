...
from acp_adapter.commands import mikasa_VERSION, SlashCommandsMixin, _estimate_tokens
...
class HermesACPAgent(SlashCommandsMixin, acp.Agent):
    ...
    def _resolve_model_selection(raw_model: str, current_provider: str) -> tuple[str, str]:
        ...
        try:
            from mikasa_cli.models import detect_provider_for_model, parse_model_input
    ...
    def _schedule_mcp_late_refresh(self, state: SessionState) -> None:
        ...
        try:
            from mikasa_cli.mcp_startup import mcp_discovery_in_flight
        except Exception:
            return
        ...
        def _wait_then_refresh() -> None:
            try:
                from mikasa_cli.mcp_startup import join_mcp_discovery
    ...
    def _run_agent_turn(
        ...
        with contextlib.ExitStack() as stack:
            ...
            stack.callback(_restore_env, "mikasa_SESSION_ID", os.environ.get("mikasa_SESSION_ID"))
