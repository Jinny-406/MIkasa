...
EXTERNAL_GATEWAY_SUPERVISOR_ENV = "mikasa_GATEWAY_EXTERNAL_SUPERVISOR"
...
def is_gateway_supervisor_process(environ: Mapping[str, str] | None = None) -> bool:
    ...
    return bool(env.get("INVOCATION_ID") or env.get("mikasa_S6_SUPERVISED_CHILD") or (xpc_service and xpc_service != "0")
