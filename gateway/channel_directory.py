...
def _directory_path() -> Path:
    return DIRECTORY_PATH or get_mikasa_home() / "channel_directory.json"


def _aliases_path() -> Path:
    return CHANNEL_ALIASES_PATH or get_mikasa_home() / "channel_aliases.json"
...
def _build_from_sessions_json(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_mikasa_home() / "sessions" / "sessions.json"
