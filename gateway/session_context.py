...
_SESSION_VARS = (
    ...
    "mikasa_SESSION_PLATFORM", "mikasa_SESSION_SOURCE", "mikasa_SESSION_CHAT_ID",
    "mikasa_SESSION_CHAT_TYPE", "mikasa_SESSION_CHAT_NAME", "mikasa_SESSION_THREAD_ID",
    "mikasa_SESSION_USER_ID", "mikasa_SESSION_USER_ID_ALT", "mikasa_SESSION_USER_NAME",
    "mikasa_SESSION_SCOPE_ID", "mikasa_SESSION_KEY", "mikasa_SESSION_ID",
    "mikasa_UI_SESSION_ID", "mikasa_SESSION_MESSAGE_ID", "mikasa_SESSION_PROFILE",
    "mikasa_BROWSER_CONTROL_PRINCIPAL", "mikasa_BROWSER_CONTROL_TRANSPORT_FAMILY",
    "mikasa_CRON_SESSION",
))
...
_SESSION_ASYNC_DELIVERY = ContextVar("mikasa_SESSION_ASYNC_DELIVERY", default=_UNSET)

# Cron auto-delivery vars, set per-job in run_job() so concurrent jobs don't clobber.
_CRON_AUTO_DELIVER_PLATFORM = ContextVar("mikasa_CRON_AUTO_DELIVER_PLATFORM", default=_UNSET)
_CRON_AUTO_DELIVER_CHAT_ID = ContextVar("mikasa_CRON_AUTO_DELIVER_CHAT_ID", default=_UNSET)
_CRON_AUTO_DELIVER_THREAD_ID = ContextVar("mikasa_CRON_AUTO_DELIVER_THREAD_ID", default=_UNSET)
...
def session_is_messaging_surface() -> bool:
    ...
    platform = os.getenv("mikasa_PLATFORM") or get_session_env("mikasa_SESSION_PLATFORM", "")
    idents = (platform, get_session_env("mikasa_SESSION_SOURCE", ""))
