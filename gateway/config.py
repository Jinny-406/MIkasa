...
def _normalize_multiplex_profile_allowlist(value: Any) -> Optional[List[str]]:
    ...
    from mikasa_cli.profiles import normalize_profile_name, validate_profile_name
...
class GatewayConfig:
    ...
    sessions_dir: Path = field(default_factory=lambda: get_mikasa_home() / "sessions")
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        return cls(
            ...
            sessions_dir=Path(data["sessions_dir"]) if "sessions_dir" in data else get_mikasa_home() / "sessions",
