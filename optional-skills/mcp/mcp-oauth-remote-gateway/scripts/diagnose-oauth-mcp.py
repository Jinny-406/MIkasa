...
Usage:
  ...
  <server_name> matches the files in $MIKASA_HOME/mcp-tokens/<server>.json etc.
...
def _mikasa_home():
    ...
    try:
        ...
        return os.environ.get("mikasa_HOME") or os.path.expanduser("~/.hermes")


def _tokens_dir():
    return os.path.join(_mikasa_home(), "mcp-tokens")
