...
Data file: $MIKASA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_mikasa_home = Path(os.environ.get("mikasa_HOME", Path.home() / ".hermes"))
DATA_DIR = _mikasa_home / "skills" / "productivity" / "memento-flashcards" / "data"
