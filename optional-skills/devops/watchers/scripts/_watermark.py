...
def _state_dir() -> Path:
    ...
    # Default: $MIKASA_HOME/watcher-state/, falling back to ~/.hermes/watcher-state/.
    MIKASA_HOME = os.environ.get("mikasa_HOME") or str(Path.home() / ".hermes")
    return Path(MIKASA_HOME) / "watcher-state"
