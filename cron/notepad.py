...
# ticks (set_mikasa_home_override) cannot leak one profile's notepad rows into the import-time home
...
def _current_notepad_file() -> Path:
    return NOTEPAD_FILE or (get_mikasa_home().resolve() / "cron" / "notepad.db")
