...
def test_dashboard_oauth_gate_engages_on_non_loopback_bind(
    ...
    start_container(
        ...
        "mikasa_DASHBOARD=1",
        "mikasa_DASHBOARD_HOST=0.0.0.0",
        "mikasa_DASHBOARD_OAUTH_CLIENT_ID=agent:test-instance",
        cmd="sleep 120",
    )
    ...
    assert "nous" in provider_names, (
        ...
        f"mikasa_DASHBOARD_OAUTH_CLIENT_ID is set. Got: {payload!r}"
    )
