...
``MIKASA_HOME`` or secret-scrub propagation.
...
SCAN_DIRS = ("agent", "mikasa_cli", "tools", "gateway", "cron", "tui_gateway")
SCAN_ROOT_FILES = ("cli.py", "mikasa_constants.py")
