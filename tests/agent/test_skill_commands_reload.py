...
def MIKASA_HOME(monkeypatch):
    ...
    monkeypatch.setattr(_st, "mikasa_HOME", home, raising=False)
...
class TestReloadSkillsHelper:
    ...
    def test_detects_removed_skill_carries_description(self, MIKASA_HOME):
        from agent.skill_commands import reload_skills

        skill_dir = _write_skill(MIKASA_HOME / "skills", "demo", "soon to be gone")
    ...
    def test_does_not_invalidate_prompt_cache_snapshot(self, MIKASA_HOME):
