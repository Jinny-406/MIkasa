...
def fake_homes(tmp_path, monkeypatch):
    """Point MIKASA_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_mikasa_home /
    get_default_mikasa_root) instead of monkeypatching private helpers —
    ...
    MIKASA_HOME=<root>/profiles/<name> makes get_default_mikasa_root()
