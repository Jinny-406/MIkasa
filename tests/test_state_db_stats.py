...
import mikasa_cli.doctor_state
...
def test_collect_and_render_stale_fts_holder_deferral(populated_db):
    ...
    from mikasa_cli.doctor_state import _render_state_db_stats
...
def test_render_warns_on_large_db():
    from mikasa_cli.doctor_state import STATE_DB_SIZE_WARN_BYTES, _render_state_db_stats
