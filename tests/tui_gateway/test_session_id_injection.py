...
def test_set_session_context_injects_agent_session_id(monkeypatch):
    """mikasa_SESSION_ID must equal the live agent.session_id after binding."""
    _install_session(
    ...
    assert get_session_env("mikasa_SESSION_ID") == "20260722_deadbeef"
...
def test_set_session_context_falls_back_to_session_key(monkeypatch):
    ...
    assert get_session_env("mikasa_SESSION_ID") == "skey-xyz"
