...
def test_lazy_recall_open_is_owned_by_the_agent(monkeypatch):
    ...
    monkeypatch.setattr("mikasa_state_registry.acquire", _factory)
...
def build_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(server, "set_mikasa_home_override", lambda _home: None)
    monkeypatch.setattr(server, "reset_mikasa_home_override", lambda _tok: None)
