...
against real honcho.json files under temp MIKASA_HOMEs, with the same
...
class TestBackgroundThreadIsolation:
    ...
    def test_spawn_context_thread_sees_profile_override(self, tmp_path):
        """spawn_context_thread must carry the caller's MIKASA_HOME override."""
