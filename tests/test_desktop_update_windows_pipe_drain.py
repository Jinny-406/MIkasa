    ...
    *logstall* -- a step that is silent on its pipes but appends to the
    ...
    env = {
        **os.environ,
        ...
        "mikasa_UPDATE_PIPE_DRAIN_SECONDS": "3",
        "mikasa_UPDATE_STEP_IDLE_SECONDS": "3",
        "mikasa_SELFTEST_HOLD_SECONDS": "45",
    }
