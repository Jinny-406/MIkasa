...
Uses a temp MIKASA_HOME + real `load_config_readonly` (the config cache is
...
def _write_home(tmp_path, monkeypatch, reasoning_echo: bool):
    """Point MIKASA_HOME at a temp profile declaring a named custom provider."""
    ...
    try:
        from mikasa_cli import config as _cfg
