...
pytestmark = pytest.mark.skipif(
    os.environ.get("mikasa_RUN_E2E", "0") != "1",
...
def test_iron_proxy_swaps_authorization_header_end_to_end(MIKASA_HOME, monkeypatch):
...
def test_iron_proxy_swaps_x_api_key_header_end_to_end(MIKASA_HOME, monkeypatch):
...
def test_iron_proxy_management_reload_end_to_end(MIKASA_HOME, monkeypatch):
