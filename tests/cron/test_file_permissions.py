...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("mikasa_cli.config.get_config_path", return_value=config_path), \
             patch("mikasa_cli.config.ensure_mikasa_home"):
    ...
    def test_ensure_mikasa_home_sets_0700(self):
        home = Path(self.tmpdir) / ".hermes"
        with patch("mikasa_cli.config.get_mikasa_home", return_value=home):
