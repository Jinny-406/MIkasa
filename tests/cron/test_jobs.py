...
class TestGetDueJobs:
    ...
    def test_run_claim_heartbeat_keeps_long_run_claimed_past_ttl(
        ...
        monkeypatch.delenv("mikasa_CRON_TIMEOUT", raising=False)
...
class TestLateEnvRepointScopesStore:
    """A MIKASA_HOME set AFTER cron.jobs import must scope the store even
    ...
    def test_use_cron_store_override_still_wins(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("mikasa_HOME", str(tmp_path / "env-home"))
    ...
    def test_public_io_after_late_env_repoint_leaves_old_file_untouched(
        ...
        called after a post-import mikasa_HOME repoint must operate on the NEW
        ...
        monkeypatch.setattr(jobs, "mikasa_DIR", sim_old_home)
        ...
        monkeypatch.setenv("mikasa_HOME", str(new_home))
