...
from ``mikasa_cli.config`` (get_env_value / save_env_value / remove_env_value)
...
import mikasa_cli.cli_output as cli_output_mod
...
def _patch_setup_io(monkeypatch, prompts, saved, removed, existing):
    ...
    import mikasa_cli.slack_cli as slack_cli_mod
