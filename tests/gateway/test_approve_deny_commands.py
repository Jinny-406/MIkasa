...
class TestBlockingApprovalE2E:
    ...
    def setup_method(self):
        ...
        os.environ.pop("mikasa_GATEWAY_SESSION", None)
        os.environ.pop("mikasa_EXEC_ASK", None)
        os.environ.pop("mikasa_SESSION_KEY", None)
    ...
    def test_blocking_approval_uses_canonical_timeout(self, approval_config, monkeypatch):
        ...
        def agent_thread():
            ...
            os.environ["mikasa_SESSION_KEY"] = session_key
            try:
                with patch(
...
class TestFallbackNoCallback:
    ...
    def test_no_callback_returns_approval_required(self):
        ...
        os.environ["mikasa_EXEC_ASK"] = "1"
        os.environ["mikasa_SESSION_KEY"] = "no-callback-test"
        try:
...
class TestCrossSessionApprovalIsolation:
    ...
    process-global ``os.environ["mikasa_SESSION_KEY"]`` inside
    ...
    def test_contextvar_wins_over_clobbered_environ(self):
        ...
        os.environ["mikasa_SESSION_KEY"] = "session-B"
    ...
    def test_unset_contextvar_does_not_fall_back_to_clobbered_environ(self):
        ...
        os.environ["mikasa_SESSION_KEY"] = "session-B-stale"
    ...
    def test_two_concurrent_sessions_route_to_own_queue_contextvar_only(self):
        ...
        ``os.environ["mikasa_SESSION_KEY"]``. This proves the contextvar is
