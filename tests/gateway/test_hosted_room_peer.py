...
def test_room_link_endpoint_reads_supported_config_with_env_override(
    ...
    monkeypatch.setenv("mikasa_HOME", str(home))
    monkeypatch.delenv("mikasa_ROOM_LINK_URL", raising=False)
    ...
    monkeypatch.setenv(
        "mikasa_ROOM_LINK_URL", "https://override.example.test/hermes"
    )
...
def test_self_advertised_endpoint_is_explicit_and_validated(
    ...
    if configured is None:
        ...
        monkeypatch.setenv("mikasa_ROOM_LINK_URL", configured)
