...
def _run_setup_feishu(
    *,
    ...
    with patch("mikasa_cli.config.save_env_value", side_effect=mock_save), \
         patch("mikasa_cli.config.get_env_value", side_effect=mock_get), \
         patch("mikasa_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("mikasa_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("mikasa_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("mikasa_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("mikasa_cli.cli_output.print_header"), \
         patch("mikasa_cli.cli_output.print_info"), \
         patch("mikasa_cli.cli_output.print_success"), \
         patch("mikasa_cli.cli_output.print_warning"), \
         patch("mikasa_cli.cli_output.print_error"), \
