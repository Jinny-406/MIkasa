...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("mikasa_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("mikasa_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("mikasa_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
