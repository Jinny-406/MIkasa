...
_TIER1_SAMPLE = {
    ...
    "mikasa_DASHBOARD_SESSION_TOKEN": "dash-secret",
}
...
class TestDelegatedChildMarker:
    def test_delegated_child_context_scrubs_parent_kanban_keys_and_sets_marker(self):
        ...
        with patch.dict(
            ...
            {
                **_SAFE_SAMPLE,
                "mikasa_KANBAN_TASK": "t_parent",
                "mikasa_KANBAN_RUN_ID": "123",
                "mikasa_KANBAN_DB": "/tmp/parent-kanban.db",
                "mikasa_KANBAN_WORKSPACE": "/tmp/parent-workspace",
            },
            clear=True,
        ):
