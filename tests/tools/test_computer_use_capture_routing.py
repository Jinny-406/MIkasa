...
* ``mikasa_constants.get_mikasa_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_mikasa_dir so cache writes land under tmp_path."""
    ...
    with patch("mikasa_constants.get_mikasa_dir", _fake_get):
        yield cache_dir
