...
class TestWriteDenyExactPaths:
    ...
    def test_hermes_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        # Sanity check: MIKASA_HOME does point to the profile dir, not the root.
        from mikasa_constants import get_mikasa_home, get_default_mikasa_root
