...
Real config files in a temp MIKASA_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated MIKASA_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "mikasa_LOCAL_STT_LANGUAGE",
    ):
