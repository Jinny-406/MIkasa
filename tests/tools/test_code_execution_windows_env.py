...
class TestPosixEquivalence:
    ...
    _POSIX_SYNTHETIC_ENV = {
        ...
        "mikasa_HOME": "/home/alice/.hermes",        # allowlisted → kept
        "mikasa_PROFILE": "default",                 # allowlisted → kept
        "mikasa_INTERACTIVE": "1",                   # not allowlisted → dropped
        "mikasa_BASE_URL": "https://api.internal",   # not allowlisted → dropped
        "mikasa_KANBAN_DB": "postgres://u:p@h/db",   # not allowlisted → dropped
...
# let the child import mikasa_tools, a user script that printed non-ASCII
