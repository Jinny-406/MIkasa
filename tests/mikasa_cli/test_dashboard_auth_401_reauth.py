...
from mikasa_cli.dashboard_auth import clear_providers, register_provider
from mikasa_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
from mikasa_cli.dashboard_auth.cookies import (
    SESSION_AT_COOKIE,
...
from tests.mikasa_cli.conftest_dashboard_auth import StubAuthProvider
...
class TestTransparentRefreshOnAccessTokenEviction:
    ...
    def _build_rt_only_app(self):
        ...
        """
        import time as _t
        from tests.mikasa_cli.conftest_dashboard_auth import _sign
...
class TestAutoSsoRedirect:
    ...
    from mikasa_cli.dashboard_auth.cookies import SSO_ATTEMPT_COOKIE
...
class TestNextSameOriginValidation:
    ...
    def test_safe_next_validator_accepts_same_origin(self):
        from mikasa_cli.dashboard_auth.middleware import _safe_next_target
...
class TestValidatePostLoginTarget:
    ...
    def test_accepts_same_origin_paths(self):
        from mikasa_cli.dashboard_auth.routes import _validate_post_login_target
...
class TestRenderLoginHtmlNext:
    ...
    def test_no_next_emits_plain_button(self):
        from mikasa_cli.dashboard_auth.login_page import render_login_html
...
class TestAuthLoginPkceCookieNext:
    ...
    def test_no_next_query_omits_next_segment(self, gated_app):
        ...
        assert r.status_code == 302
        cookies = r.headers.get_list("set-cookie")
        pkce = next(c for c in cookies if "mikasa_session_pkce" in c)
