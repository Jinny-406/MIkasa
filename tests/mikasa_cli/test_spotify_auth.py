...
import mikasa_cli.auth_spotify as auth_spotify
from mikasa_cli.auth import AuthError, resolve_spotify_runtime_credentials
...
def test_auth_spotify_status_command_reports_logged_in(capsys, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from mikasa_cli.auth_commands import auth_status_command
