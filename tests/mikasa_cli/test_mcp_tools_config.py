...
from mikasa_cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "mikasa_cli.curses_ui.curses_checklist"
_SAVE = "mikasa_cli.tools_config.save_config"
