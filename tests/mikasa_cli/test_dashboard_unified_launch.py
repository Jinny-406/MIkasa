...
class TestUnifiedDashboardRouting:
    ...
    def test_profile_launch_reexecs_machine_dashboard(self, main_mod, monkeypatch):
        ...
        monkeypatch.setattr(
            "mikasa_cli.profiles.get_active_profile_name", lambda: "worker_x"
        )
        ...
        # MIKASA_HOME.  For a standard install (MIKASA_HOME unset) that root is
        ...
        assert env.get("mikasa_HOME") == str(get_default_mikasa_root())
