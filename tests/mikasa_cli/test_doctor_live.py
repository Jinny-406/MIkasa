...
from mikasa_cli import doctor_live
from mikasa_cli.doctor_live import (
    ProbeResult,
...
class TestBrowserAvailableNpxRung:
    ...
    def _block_path_and_node_modules_checks(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("mikasa_cli.doctor.MIKASA_HOME", tmp_path / "home")
        monkeypatch.setattr("mikasa_cli.doctor.PROJECT_ROOT", tmp_path / "root")
