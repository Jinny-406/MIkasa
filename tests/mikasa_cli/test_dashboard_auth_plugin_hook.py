...
from mikasa_cli.dashboard_auth import clear_providers, get_provider
...
from mikasa_cli.dashboard_auth import registry as _auth_registry
...
def _real_ctx() -> tuple[PluginManager, PluginContext]:
    manager = PluginManager(scope_key=MIKASA_HOME_key())
