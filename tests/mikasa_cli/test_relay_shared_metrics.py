...
from mikasa_cli.observability import shared_metrics as shared_metrics_module
from mikasa_cli.observability.shared_metrics import SharedMetricsStore
from mikasa_cli.observability.shared_metrics_contract import (
...
def test_v1_outbox_package_exports_unchanged_after_upgrade(tmp_path):
    ...
    payload = {
        ...
        "resource": {"mikasa_version": "legacy-version"},
        "metrics": [
            {
                "name": LEGACY_MODEL_CALL_METRIC,
                "type": "counter",
