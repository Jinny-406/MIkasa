...
import mikasa_cli.model_switch_providers as hermes_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr("mikasa_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import mikasa_cli.models as hm
    import mikasa_cli.models_catalog_static as hermes_cli_models_catalog_static
    from mikasa_cli import models_catalog_static
