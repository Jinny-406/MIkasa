...
from mikasa_cli import kanban_transfer as kt
from mikasa_cli.archive_safe import normalize_archive_parts, safe_extract_targz
...
def kanban_root(tmp_path, monkeypatch):
    ...
    def _use(name: str) -> Path:
        ...
        monkeypatch.setenv("mikasa_KANBAN_HOME", str(root))
        for var in ("mikasa_KANBAN_DB", "mikasa_KANBAN_WORKSPACES_ROOT",
                    "mikasa_KANBAN_ATTACHMENTS_ROOT", "mikasa_KANBAN_BOARD"):
