...
@patch("mikasa_cli.config.detect_install_method", return_value="docker")
...
def test_format_docker_update_message_contents():
    ...
    """
    from mikasa_cli.config import format_docker_update_message
    ...
    assert "mikasa_HOME" in msg or "/opt/data" in msg, (
