...
from mikasa_cli.main import _fleet_probe_expected_runtimes
from mikasa_cli.update_inventory import RuntimeRecord
...
class TestCallSiteWiring:
    ...
    def test_settle_sleep_gated_on_expected_runtimes(self):
        ...
        from mikasa_cli import update_cmd_fleet
...
def test_unmapped_stops_are_not_expected_rows():
    ...
    from mikasa_cli.update_cmd_fleet import _GatewayRestartOutcome
