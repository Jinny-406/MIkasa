...
import mikasa_cli.main as m
import mikasa_cli.main_install_repair as hermes_cli_main_install_repair
...
def test_capture_active_tool_dependencies_uses_tools_status_probes(monkeypatch):
    from mikasa_cli import tools_config_post_setup
...
def test_cmd_update_captures_and_propagates_pre_rebuild_snapshot(
    ...
    from mikasa_cli import managed_uv, update_cmd
