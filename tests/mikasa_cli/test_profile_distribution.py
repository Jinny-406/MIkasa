...
from mikasa_cli.profile_distribution import (
    DEFAULT_DIST_OWNED,
    DistributionError,
...
class TestInstall:
    ...
    def test_update_respects_distribution_owned_allowlist(self, profile_env):
        ...
        from mikasa_cli.profile_distribution import read_manifest as _read
...
class TestInstalledAtStamp:
    ...
    def test_update_refreshes_installed_at(self, profile_env, monkeypatch):
        ...
        monkeypatch.setattr(
            "mikasa_cli.profile_distribution.datetime", _FakeDT, raising=True
        )

        from mikasa_cli.profile_distribution import update_distribution
...
class TestProfileInfoDistribution:
    ...
    def test_malformed_manifest_does_not_break_list(self, profile_env):
        from mikasa_cli.profiles import create_profile, list_profiles, get_profile_dir
