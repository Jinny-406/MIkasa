...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from mikasa_cli.pty_bridge import PtyBridge as PosixBridge
    from mikasa_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    from mikasa_cli import web_server_chat
    ...
    #       try:
    #           from mikasa_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from mikasa_cli.win_pty_bridge import" in src
    assert "from mikasa_cli.pty_bridge import" in src
