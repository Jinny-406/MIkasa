...
class TestGetCopilotModelContext:
    ...
    @patch("mikasa_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("mikasa_cli.models._urlopen_model_catalog_request")
    ...
    @patch("mikasa_cli.models.fetch_github_model_catalog", return_value=[])
