...
``$MIKASA_HOME/plugins/``, runs ``PluginManager().discover_and_load()``,
...
class TestRegisterTTSProvider:
    ...
    def test_accepts_valid_provider(self):
        ...
        _enable(MIKASA_HOME, "my-tts-plugin")
    ...
    def test_rejects_non_provider(self, caplog):
        ...
        _enable(MIKASA_HOME, "bad-tts-plugin")
    ...
    def test_rejects_builtin_shadow(self, caplog):
        ...
        _enable(MIKASA_HOME, "shadow-tts-plugin")
