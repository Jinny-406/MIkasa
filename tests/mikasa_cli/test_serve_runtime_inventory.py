...
import mikasa_cli.update_inventory as update_inventory
from mikasa_cli import main as cli_main
import mikasa_cli.main_install_repair as main_install_repair
import mikasa_cli.main_dashboard as main_dashboard
...
def test_register_self_records_structured_detail(tmp_path, monkeypatch):
    from mikasa_cli import process_identity as pi
...
def test_inventory_includes_manual_serve_from_ledger(monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "mikasa_cli.process_identity", fake_pi)
...
def test_scan_dashboard_processes_includes_ledger_only_serves(monkeypatch):
    ...
    import mikasa_cli.dashboard_procs as dp
