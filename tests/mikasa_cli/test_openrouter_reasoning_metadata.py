...
from mikasa_cli.models import clamp_reasoning_effort_to_supported
from mikasa_cli.models_reasoning_caps import parse_openrouter_reasoning_capabilities
...
class TestOpenRouterModelReasoningCapabilities:
    ...
    def test_known_model(self, monkeypatch):
        from mikasa_cli.models_reasoning_caps import openrouter_model_reasoning_capabilities
