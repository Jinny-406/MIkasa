...
from mikasa_cli import _subprocess_compat
...
class TestPidIsHermes:
    ...
    def test_hermes_match_requires_token_boundary(self):
        ...
        assert _subprocess_compat._text_names_hermes(
            r"C:\Users\x\.hermes-runtime\python.exe -m mikasa_cli.main"
        ) is True
        assert _subprocess_compat._text_names_hermes(
...
class TestStopProcessTrees:
    ...
    def test_foreign_pids_only_probed(self):
        with mock.patch(
            ...
            "mikasa_cli._subprocess_compat.pid_is_hermes", return_value=False
