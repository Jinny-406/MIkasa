...
import mikasa_cli.main as hm
import mikasa_cli.main_install_repair as main_install_repair
from mikasa_cli.update_cmd import _resume_windows_gateways_after_update
...
def test_merge_helper_reads_token_keys_into_restart_outcome(monkeypatch):
    ...
    with patch("mikasa_cli.update_receipt.record_gateway_restart", lambda **kw: None):
