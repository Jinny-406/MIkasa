...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from mikasa_cli.backup import _format_size as backup
    from mikasa_cli.checkpoints import _fmt_bytes as checkpoints
    from mikasa_cli.sizefmt import format_bytes as doctor
