...
def _env_value(MIKASA_HOME: Path, key: str) -> str | None:
...
def test_aborted_setup_does_not_enable_whatsapp(isolated_home, monkeypatch):
    ...
    """
    from mikasa_cli.main_platform_setup import cmd_whatsapp
    ...
    monkeypatch.setattr("mikasa_cli.main._require_tty", lambda *_a, **_kw: None)
