...
_VARS = ("mikasa_SAFE_MODE", "mikasa_IGNORE_USER_CONFIG", "mikasa_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["mikasa_SAFE_MODE"] == "1"
        assert os.environ["mikasa_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["mikasa_IGNORE_RULES"] == "1"
        return True
