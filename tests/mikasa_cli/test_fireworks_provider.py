...
from mikasa_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS, normalize_provider
...
class TestFireworksAliases:
    ...
    def test_providers_normalize_provider(self, alias):
        from mikasa_cli.providers import normalize_provider as normalize_in_providers
