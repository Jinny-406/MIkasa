...
class TestChatVerboseArg:
    ...
    def test_cmd_chat_forwards_none_when_verbose_is_absent(self, monkeypatch):
        ...
        fake_banner = types.ModuleType("mikasa_cli.banner")
        ...
        monkeypatch.setitem(sys.modules, "mikasa_cli.banner", fake_banner)
...
class TestAcceptHooksOnAgentSubparsers:
    ...
    # One driver subprocess parses ALL argvs: mikasa_cli.main is a very heavy
    # import (previously 11 separate `python -m mikasa_cli.main` spawns with a
