...
from mikasa_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(MIKASA_HOME, memory_text="", user_text=""):
    mem_dir = MIKASA_HOME / "memories"
...
def _seed_skill(MIKASA_HOME, name, description):
    skill_dir = MIKASA_HOME / "skills" / "demo" / name
