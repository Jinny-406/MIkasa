...
* ``mikasa_cli.config._normalize_custom_provider_entry`` passed the raw
...
from mikasa_cli.config import _canonical_api_mode, _normalize_custom_provider_entry
from mikasa_cli.runtime_provider import _parse_api_mode, _VALID_API_MODES
...
class TestCanonicalApiMode:
    ...
    def test_every_alias_lands_in_the_valid_set(self):
        ...
        from mikasa_cli.config import _API_MODE_ALIASES
