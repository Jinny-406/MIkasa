...
from mikasa_cli.profiles import export_profile
...
def _patch_named_profile(monkeypatch, profiles_root, profile_dir):
    monkeypatch.setattr("mikasa_cli.profiles._get_profiles_root", lambda: profiles_root)
    monkeypatch.setattr("mikasa_cli.profiles.get_profile_dir", lambda n: profile_dir)
    monkeypatch.setattr("mikasa_cli.profiles.validate_profile_name", lambda n: None)
