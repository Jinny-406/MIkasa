...
import mikasa_cli.web_routers.dashboard_ui as _rt_dashboard_ui
...
def _patch_minimal_hub_dependencies(monkeypatch, *, check_fn, discover_all_plugins=None):
    ...
    monkeypatch.setattr(_cfg_mod, "get_mikasa_home", lambda: Path("/tmp/hermes-home"))
...
def test_plugin_install_endpoint_invalidates_hub_cache(monkeypatch):
    ...
    from mikasa_cli.web_models import _AgentPluginInstallBody
