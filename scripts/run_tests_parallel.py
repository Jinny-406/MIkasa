...
def main() -> int:
    ...
    parser.add_argument(
        ...
        "--jobs",
        type=int,
        default=int(os.environ.get("mikasa_TEST_WORKERS") or (os.cpu_count() or 4) * 2),
        help="Parallel worker count (default: $HERMES_TEST_WORKERS or cpu_count*2)",
    )
    parser.add_argument(
        "--paths",
        default=os.environ.get("mikasa_TEST_PATHS", ":".join(_DEFAULT_ROOTS)),
        help=(
    ...
    parser.add_argument(
        ...
        type=float,
        default=float(
            os.environ.get("mikasa_TEST_FILE_TIMEOUT", _DEFAULT_FILE_TIMEOUT_SECONDS)
        ),
        help=(
    ...
    parser.add_argument(
        ...
        type=int,
        default=int(
            os.environ.get("mikasa_TEST_FILE_RETRIES", _DEFAULT_FILE_RETRIES)
        ),
        help=(
    ...
    slice_raw = args.slice or os.environ.get("mikasa_TEST_SLICE")
