...
# Ensure MIKASA_HOME is set for imports that touch it at module level.
os.environ.setdefault("mikasa_HOME", os.path.join(os.path.expanduser("~"), ".hermes"))

from mikasa_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
