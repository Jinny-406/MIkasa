...
MIKASA_HOME so the operator's own telemetry state is untouched.
...
def main() -> int:
    ...
    os.environ["mikasa_HOME"] = str(scratch)
    ...
    from mikasa_cli.observability.shared_metrics_send_config import (
        resolve_send_config,
    )
    ...
    print(f"scratch MIKASA_HOME : {scratch}")
