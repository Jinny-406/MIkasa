...
# `<db>.repair.lock` (offline schema surgery, minutes in VACUUM).  Lives here: mixins cannot import mikasa_state.
...
# cannot import mikasa_state (cycle). The lock file is `<db>.fts_rebuild.lock`, distinct from
