...
# Must mirror _STALE_TOOL_CALL_MARKER_RE in mikasa_state.py; kept local so importing
...
def _decode_inline_moa_turn(user_message, persist_user_message):
    ...
    try:
        from mikasa_cli.moa_config import decode_moa_turn
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'PARTIAL_STREAM_STUB_ID': ('mikasa_constants', 'PARTIAL_STREAM_STUB_ID'),
