...
_DELEGATED_CHILD_CONTEXT: ContextVar[bool] = ContextVar("mikasa_delegated_child_context", default=False)
...
_NON_DISPATCHER_OWNED_CONTEXT: ContextVar[bool] = ContextVar("mikasa_non_dispatcher_owned_context", default=False)

DELEGATED_CHILD_ENV_MARKER = "mikasa_DELEGATED_CHILD_CONTEXT"

KANBAN_ENV_KEYS: tuple[str, ...] = (
    "mikasa_KANBAN_TASK", "mikasa_KANBAN_RUN_ID", "mikasa_KANBAN_WORKSPACE", "mikasa_KANBAN_WORKSPACES_ROOT",
    "mikasa_KANBAN_CLAIM_LOCK", "mikasa_KANBAN_BOARD", "mikasa_KANBAN_DB",
)
