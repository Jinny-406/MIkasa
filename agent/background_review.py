...
def build_memory_write_metadata(
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("mikasa_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
...
def _run_review_fork(
    ...
    from mikasa_cli.plugins import set_thread_tool_whitelist, clear_thread_tool_whitelist
