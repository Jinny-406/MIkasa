...
YAML files in ``<MIKASA_HOME>/skill-bundles/`` (``name``, ``description``,
...
def _bundles_dir() -> Path:
    """Bundles directory: ``HERMES_BUNDLES_DIR`` override (tests) or ``<MIKASA_HOME>/skill-bundles``."""
    override = os.environ.get("mikasa_BUNDLES_DIR")
    return Path(override).expanduser() if override else get_mikasa_home() / "skill-bundles"
