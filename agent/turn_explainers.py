...
def _display_flag_enabled(agent, *, env_var: str, config_key: str, cache_attr: str) -> bool:
    ...
    and tests patch it at ``mikasa_cli.config``). Any failure → True (safe default: on)."""
    try:
...
class TurnExplainersMixin:
    ...
    def _file_mutation_verifier_enabled(self) -> bool:
        ...
        return _display_flag_enabled(
            self, env_var="mikasa_FILE_MUTATION_VERIFIER", config_key="file_mutation_verifier",
    ...
    def _turn_completion_explainer_enabled(self) -> bool:
        ...
        return _display_flag_enabled(
            self, env_var="mikasa_TURN_COMPLETION_EXPLAINER", config_key="turn_completion_explainer",
