...
from mikasa_constants import display_mikasa_home, is_termux as _is_termux_environment
from agent.turn_context import extract_api_content_sidecar
from mikasa_cli.browser_connect import (
...
def _db_unavailable_line() -> str:
    from mikasa_state import format_session_db_unavailable
...
class CLICommandsMixin:
    ...
    def _snapshot_list(self, parts) -> None:
        from mikasa_cli.backup import list_quick_snapshots
        snaps = list_quick_snapshots()
        if not snaps:
            return _pr("  No state snapshots yet.", "  Create one: /snapshot create [label]")
        print(f"  State snapshots ({display_mikasa_home()}/state-snapshots/):\n")
    ...
    def _snapshot_restore(self, parts) -> None:
        from mikasa_cli.backup import list_quick_snapshots, restore_quick_snapshot
        if len(parts) < 3:
    ...
    def _snapshot_prune(self, parts) -> None:
        from mikasa_cli.backup import prune_quick_snapshots
        keep = 20
        if len(parts) > 2:
            try:
                keep = int(parts[2])
    ...
    def _handle_export_command(self, command: str):
        ...
        from mikasa_cli.profiles import export_profile, get_active_profile_name, get_profile_export_path
    ...
    def _handle_import_command(self, command: str):
        ...
        new profile."""
        from mikasa_cli.profiles import check_alias_collision, create_wrapper_script, import_profile
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from mikasa_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from mikasa_cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        try:
            from mikasa_cli.clipboard import is_remote_shell_session, write_clipboard_text
    ...
    def _run_tools_config(self, **ns) -> None:
        ...
        from mikasa_cli.tools_config import tools_disable_enable_command
    ...
    def _handle_profile_command(self):
        ...
        from mikasa_cli.slash_exec import CommandContext, execute_command
    ...
    def _resolve_resume_target(self, target: str):
        ...
        if target.isdigit():
            ...
            from mikasa_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_branch_command(self, cmd_original: str) -> None:
        ...
        try:
            self._session_db.create_session(
                session_id=new_session_id, source=os.environ.get("mikasa_SESSION_SOURCE", "cli"),
    ...
    def _worktree_prune(self, repo_root: str, rest: str) -> None:
        import cli as _cli
        from mikasa_cli import worktree_gc
        rest = rest.lower()
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        persistence goes through mikasa_cli.personality, the single owner of personality state."""
        from mikasa_cli.personality import (
        ...
        if not name:
            ...
            try:
                from mikasa_cli.config import cfg_get, read_raw_config
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from mikasa_cli.pets import _set_active
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        try:
            from mikasa_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from mikasa_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from mikasa_cli.curator import cli_main
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        from mikasa_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in review_words:
            from mikasa_cli.write_approval_commands import handle_pending_subcommand
            ...
            if out is not None:
                return print(out)
        from mikasa_cli.skills_hub import handle_skills_slash
    ...
    def _handle_init_command(self, cmd: str):
        ...
        from mikasa_cli.init_command import build_init_prompt_for_cwd
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        from mikasa_cli.heartbeat import format_interval
        arg = _command_arg(cmd)
        lower = arg.lower()
    ...
    def _heartbeat_set(self, mgr, arg: str) -> None:
        ...
        from mikasa_cli.heartbeat import parse_interval, format_interval
        ...
        if interval < 0:
            from mikasa_cli.heartbeat import MIN_INTERVAL_SECONDS
    ...
    def _goal_set(self, mgr, arg: str) -> None:
        ...
        from mikasa_cli.goals import parse_contract
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from mikasa_cli.goals import draft_contract
        mgr = self._session_manager(self._get_goal_manager, "Goals")
        if mgr is None:
            return
    ...
    def _handle_loop_command(self, cmd: str) -> None:
        ...
        if mgr is None:
            return
        from mikasa_cli.loops import dispatch_loop_command
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from mikasa_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if not new_skin:  # show current skin and list available
            ...
            return _pr("\n  Usage: /skin <name>",
                       f"  Custom skins: drop a YAML file in {display_mikasa_home()}/skins/\n")
    ...
    def _compose_in_editor(self, initial_text: str = "") -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".md", prefix="mikasa_prompt_")
        try:
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        from mikasa_cli.colors import Colors as _Colors
        from mikasa_cli.focus_view import (
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        from mikasa_cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from mikasa_cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from mikasa_cli.focus_view import format_hidden_line
    ...
    def _handle_approvals_command(self, cmd_original: str) -> None:
        ...
        from mikasa_cli.approval_mode import run_approval_mode_command
        parts = (cmd_original or "").strip().split(None, 1)
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        from mikasa_constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        anthropic = _probe("mikasa_cli.models", "_is_anthropic_fast_model", None, model)
    ...
    def _handle_update_command(self) -> bool:
        ...
        from mikasa_cli.config import is_managed, format_managed_message
        if is_managed():
            print(f"  ✗ {format_managed_message('update Mikasa Agent')}")
            return False
        # prompt_toolkit-native modal: renders above the composer, no raw input() races.
        choices = [("once", "Update Now", "exit the current session and update Mikasa Agent"),
                   ("cancel", "Cancel", "keep the current session")]
        raw = self._prompt_text_input_modal(
            title="⚕  Update Mikasa Agent",
