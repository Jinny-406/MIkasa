...
from mikasa_cli.local_runtime.estimator import HardwareBudget, LayerKind, ModelProfile, ctx_bytes
from mikasa_cli.local_runtime.gguf import model_id_from_stem
...
def _packaged_catalog() -> "tuple[CatalogEntry, ...]":
    ...
    raw = files("mikasa_cli.local_runtime").joinpath("catalog.json").read_text(encoding="utf-8")
