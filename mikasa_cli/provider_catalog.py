...
def provider_catalog() -> list[ProviderDescriptor]:
    ...
    PROVIDER_REGISTRY = _safe_import("mikasa_cli.auth", "PROVIDER_REGISTRY", {})
    OPTIONAL_ENV_VARS = _safe_import("mikasa_cli.config", "OPTIONAL_ENV_VARS", {})
    ...
    MIKASA_OVERLAYS = _safe_import("mikasa_cli.providers", "MIKASA_OVERLAYS", {})
    try:
