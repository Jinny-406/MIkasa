...
from mikasa_constants import INDICATOR_STYLES
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("race", "Race a prompt across multiple models and return the best response (ULTRAPLINIAN)", "Session",
               args_hint="<prompt> [--models model1,model2] [--timeout 30]", busy_policy="reject"),
    ...
    CommandDef("update", "Update Mikasa Agent to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Mikasa Agent version", "Info", aliases=("v",),
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('mikasa_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('mikasa_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('mikasa_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('mikasa_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('mikasa_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('mikasa_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('mikasa_cli.commands_platforms', 'telegram_menu_max_commands'),
}
