...
def normalize_command(command: str) -> str:
    ...
    from tools.approval_detection import _rewrite_resolved_mikasa_home, _rewrite_resolved_user_home
    return " ".join(_rewrite_resolved_user_home(_rewrite_resolved_mikasa_home(command)).split())
...
def approvals_command(args) -> int:
    ...
    if sub == "test":
        from mikasa_cli.approvals_test import approvals_test_command
