...
from mikasa_cli.plugin_capabilities import VALID_CAPABILITY_IDS
from mikasa_cli.plugin_capabilities import parse_declared_capabilities as _parse_declared_capabilities
from mikasa_cli.plugins_manifest import (
...
ENTRY_POINTS_GROUP = "mikasa_agent.plugins"
ENTRY_POINT_CAPABILITIES_GROUP = "mikasa_agent.plugin_capabilities"
...
def collect_directory_manifests() -> List[PluginManifest]:
    ...
    from mikasa_cli import plugins as _origin  # patched names resolve through the origin
    manifests: List[PluginManifest] = []
    ...
    user_dir = get_mikasa_home() / "plugins"
    logger.debug("Scanning user plugins: %s", user_dir)
    _scan("user", user_dir, "user")
    if _origin._env_enabled("mikasa_ENABLE_PROJECT_PLUGINS"):
