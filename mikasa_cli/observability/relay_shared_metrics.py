...
class _Runtime:
    ...
    def _run_send_pass(self, endpoint: str) -> None:
        from mikasa_cli.observability.shared_metrics_sender import SharedMetricsSender
...
def _raw_config() -> dict[str, Any]:
    """Read-only config snapshot (lazy import: tests patch ``mikasa_cli.config``).
    ...
    """
    from mikasa_cli.config import read_raw_config_readonly
...
def _resolved_send_config():
    ...
    from mikasa_cli.observability.shared_metrics_send_config import resolve_send_config
...
def _reconcile_send_consent_once() -> None:
    ...
    try:
        ...
        default_path = get_mikasa_home() / "telemetry" / "shared_metrics" / "metrics.sqlite3"
...
_PLUGIN_COMPAT_LAZY = {
    'CLIENT_ACTIVE_MARK': ('mikasa_cli.observability.shared_metrics_contract', 'CLIENT_ACTIVE_MARK'),
    'MODEL_CALL_PROFILE_MODEL': ('mikasa_cli.observability.shared_metrics_contract', 'MODEL_CALL_PROFILE_MODEL'),
    'SCHEMA_KEY': ('mikasa_cli.observability.shared_metrics_contract', 'SCHEMA_KEY'),
    'SCHEMA_VERSION': ('mikasa_cli.observability.shared_metrics_contract', 'SCHEMA_VERSION'),
    'SKILL_LIFECYCLE_MARK': ('mikasa_cli.observability.shared_metrics_contract', 'SKILL_LIFECYCLE_MARK'),
    'SKILL_LOAD_MARK': ('mikasa_cli.observability.shared_metrics_contract', 'SKILL_LOAD_MARK'),
    'TOOL_APPROVAL_MARK': ('mikasa_cli.observability.shared_metrics_contract', 'TOOL_APPROVAL_MARK'),
    'TOOL_CALL_SCOPE': ('mikasa_cli.observability.shared_metrics_contract', 'TOOL_CALL_SCOPE'),
    'model_call_fields': ('mikasa_cli.observability.shared_metrics_contract', 'model_call_fields'),
    'skill_lifecycle_fields': ('mikasa_cli.observability.shared_metrics_contract', 'skill_lifecycle_fields'),
    'skill_load_fields': ('mikasa_cli.observability.shared_metrics_contract', 'skill_load_fields'),
    'task_start_fields': ('mikasa_cli.observability.shared_metrics_contract', 'task_start_fields'),
    'task_terminal_fields': ('mikasa_cli.observability.shared_metrics_contract', 'task_terminal_fields'),
    'task_terminal_state': ('mikasa_cli.observability.shared_metrics_contract', 'task_terminal_state'),
    'tool_approval_outcome': ('mikasa_cli.observability.shared_metrics_contract', 'tool_approval_outcome'),
    'tool_category': ('mikasa_cli.observability.shared_metrics_contract', 'tool_category'),
    'tool_terminal_fields': ('mikasa_cli.observability.shared_metrics_contract', 'tool_terminal_fields'),
}
