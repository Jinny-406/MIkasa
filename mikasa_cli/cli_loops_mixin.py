...
class CLILoopsMixin:
    ...
    def _cmd_version(self, cmd_original: str):
        from mikasa_cli.main import _print_version_info
        _print_version_info(check_updates=True)

    def _cmd_reload(self, cmd_original: str):
        from mikasa_cli.config import reload_env
        count = reload_env()
    ...
    def _cmd_plugins(self, cmd_original: str):
        ...
        try:
            ...
            if not user_entries:
                ...
                print(f"  Or drop a plugin directory into {display_mikasa_home()}/plugins/")
                if bundled_count:
    ...
    def _get_heartbeat_manager(self):
        ...
        def load():
            from mikasa_cli.heartbeat import HeartbeatManager
    ...
    def _start_heartbeat_watchdog(self):
        ...
        from mikasa_cli.heartbeat import POLL_SECONDS
    ...
    def _maybe_continue_goal_after_turn(self) -> None:
        ...
        if not last_response.strip():
            return
        try:
            from mikasa_cli.goals import gather_background_processes as _gather_bg
