...
def _codex_curated_models() -> list[str]:
    ...
    from mikasa_cli.codex_models import DEFAULT_CODEX_MODELS, _finalize_codex_models
...
# Mirrors the xAI-direct IDs from $MIKASA_HOME/models_dev_cache.json; the cache overrides it on the
...
def _xai_curated_models() -> list[str]:
    """Offline curated floor for xAI / xAI OAuth pickers: $MIKASA_HOME/models_dev_cache.json
