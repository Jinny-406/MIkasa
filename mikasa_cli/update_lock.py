...
HANDOFF_PID_ENV = "mikasa_UPDATE_HANDOFF_PID"
...
def update_marker_path() -> Path:
    ...
    updater resolves ``$MIKASA_HOME`` or the platform default and the desktop pins that same
    ...
    return get_process_mikasa_home() / MARKER_NAME
