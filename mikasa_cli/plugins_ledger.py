...
from mikasa_cli.plugins_loader import _plugin_home_scope
from mikasa_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from mikasa_cli.plugins import _PLUGINS_DEBUG
