...
HERMES_KANBAN_SPECIFY_MAX_TOKENS = max(1500, env_int("mikasa_KANBAN_SPECIFY_MAX_TOKENS", 6000))

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Mikasa Agent board.
...
def _profile_author(default: str = "specifier") -> str:
    ...
    return os.environ.get("mikasa_PROFILE") or os.environ.get("USER") or default
