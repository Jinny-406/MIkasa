"""Default SOUL.md template seeded into MIKASA_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Mikasa Agent, built by Jinny. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    "# Mikasa Agent Persona\n\n<!--\nThis file defines the agent's personality and tone.\n"
    "The agent will embody whatever you write here.\nEdit this to customize how Mikasa communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Mikasa Agent, an intelligent AI assistant created by Jinny. You are helpful, "
