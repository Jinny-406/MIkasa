...
Imports of mikasa_cli.config / azure_detect stay lazy (tests patch them at call time).
...
from mikasa_cli.model_setup_flows_common import _HTTP, _ask, _commit_model_config, _load_config_model_section, _say
...
def _azure_detect_transport(effective_url: str, effective_key: str, token_provider, current_api_mode: str):
    ...
    from mikasa_cli import azure_detect
