...
from mikasa_cli.dashboard_auth import list_session_providers
...
from mikasa_cli.dashboard_auth.prefix import prefix_from_request
from mikasa_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from mikasa_cli.dashboard_auth.request_utils import (
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('mikasa_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
