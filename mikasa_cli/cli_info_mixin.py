...
from mikasa_constants import is_termux as _is_termux_environment
from rich.markup import escape as _escape
from utils import base_url_hostname

from mikasa_cli.cli_modal_mixin import _gated_confirm
...
class CLIInfoMixin:
    ...
    def show_banner(self):
        ...
        from mikasa_cli.banner import build_welcome_banner
        self.console.clear()
        ctx_len = None
        ...
        from mikasa_cli.model_switch import is_nous_hermes_non_agentic
        if is_nous_hermes_non_agentic(getattr(self, "model", "") or ""):
            self._console_print()
            self._console_print(
                "[bold yellow]⚠  Nous Research Hermes 3 & 4 models are NOT agentic and are not "
                "designed for use with Mikasa Agent.[/]")
            self._console_print(
    ...
    def show_help(self, arg: str = ""):
        ...
        from mikasa_cli.commands import COMMANDS_BY_CATEGORY, HELP_SESSION_SUBGROUPS
        ...
        try:
            from mikasa_cli.skin_engine import get_active_help_header
    ...
    def handle_bang_shell(self, text: str) -> bool:
        ...
        from mikasa_cli.bang_shell import (
    ...
    def _show_gateway_status(self):
        ...
        try:
            ...
            print()
            print(f"  Configuration file: {display_mikasa_home()}/config.yaml")
            print()
            ...
            print(f"    2. Or configure settings in {display_mikasa_home()}/config.yaml")
            print()

    def _print_random_tip(self) -> None:
        """Best-effort discovery tip (startup + /clear); never raises."""
        try:
            from mikasa_cli.tips import get_random_tip
            _tip = get_random_tip()
            try:
    ...
    def _toggle_verbose(self):
        ...
        if getattr(self, "_focus_view_enabled", False):
            ...
            try:
                from mikasa_cli.focus_view import FOCUS_CONFIG_KEY
    ...
    def _check_config_mcp_changes(self) -> None:
        ...
        from mikasa_cli.config import get_config_path as _get_config_path
