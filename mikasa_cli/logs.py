...
def tail_log(
    ...
    *,
    ...
    log_path = get_mikasa_home() / "logs" / filename
    ...
    print(f"--- {display_mikasa_home()}/logs/{filename}{filter_desc} ({mode}) ---")
...
def list_logs() -> None:
    ...
    if not log_dir.exists():
        print(f"No logs directory at {display_mikasa_home()}/logs/")
        return

    print(f"Log files in {display_mikasa_home()}/logs/:\n")
    found = False
