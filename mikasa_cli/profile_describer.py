...
_SYSTEM_PROMPT = """You are a profile-describer for the Mikasa Agent kanban board.
...
Rules:
  ...
  - Never write "Mikasa Agent profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from mikasa_cli.kanban_specify import _extract_json_blob as _extract
