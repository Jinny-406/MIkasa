...
from mikasa_cli.model_setup_flows_common import _say
...
def cmd_whatsapp(args):
    ...
    from mikasa_cli.main import _require_tty, get_mikasa_home
    ...
    session_dir = get_mikasa_home() / "whatsapp" / "session"
    ...
    if wa_mode == "bot":
        _say("  Next steps:", "    1. Start the gateway:  hermes gateway",
             ...
             "  Tip: Agent responses are prefixed with '⚕ Mikasa Agent'")
    else:
        _say("  Next steps:", "    1. Start the gateway:  hermes gateway",
...
def cmd_whatsapp_cloud(args):
    ...
    from mikasa_cli.setup_whatsapp_cloud import run_whatsapp_cloud_setup
...
def cmd_slack(args):
    ...
    if sub == "manifest":
        from mikasa_cli.slack_cli import slack_manifest_command
