"""Mikasa skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces MIKASA_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces MIKASA_CADUCEUS)
...
# Branding shared by every Mikasa-named built-in (mono/daylight override help_header).
_MIKASA_BRANDING: Dict[str, str] = _branding(
    "Mikasa", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "graphite": {
        "name": "graphite",
        "description": "Mikasa Graphite — pearl, charcoal, and a compact wordmark",
        "colors": {
            "background": "#101112",
            "banner_border": "#59615D",
            "banner_title": "#E6E8E7",
            "banner_accent": "#BCC6C2",
            "banner_dim": "#A6AAA9",
            "banner_text": "#F0F0EE",
            "ui_accent": "#E6E8E7",
            "ui_primary": "#E6E8E7",
            ...
            "prompt": "#E6E8E7",
            "input_rule": "#59615D",
            "response_border": "#59615D",
            "status_bar_bg": "#191D1B",
            "status_bar_text": "#DDE2DF",
            "status_bar_strong": "#E6E8E7",
            "status_bar_dim": "#A6AAA9",
            "status_bar_good": "#A8C9B7",
            "status_bar_warn": "#DBC596",
            "status_bar_bad": "#EBA8A8",
            "status_bar_critical": "#F0A0A0",
            "session_label": "#BCC6C2",
            "session_border": "#8B9490",
            "completion_menu_bg": "#1B1E1E",
            "completion_menu_current_bg": "#414A45",
            "completion_menu_meta_bg": "#1B1E1E",
            "completion_menu_meta_current_bg": "#414A45",
            "selection_bg": "#414A45",
            "shell_dollar": "#BCC6C2",
            "voice_status_bg": "#191D1B",
            "syntax_string": "#C4D4CB",
            "syntax_number": "#D4D1C4",
            "syntax_keyword": "#E6E8E7",
            "syntax_comment": "#A6AAA9"
        },
        "spinner": {
            "waiting_faces": [
                "(·    )",
        ...
        "branding": {
            ...
            "tagline": "PERSONAL AGENT",
            "welcome": "Mikasa is ready. Type / for commands.",
            "goodbye": "See you next time.",
            "response_label": " Mikasa ",
            "prompt_symbol": "❯",
            "help_header": "Mikasa commands"
        },
        "tool_prefix": "│",
        "banner_logo": "[bold #E6E8E7]M  I  K  A  S  A[/]  [#A6AAA9]○  PERSONAL AGENT[/]",
        "banner_hero": "[#E6E8E7]M I K A S A[/]\n[#A6AAA9]PERSONAL AGENT[/]"
    },
    "default": {
        "name": "default", "description": "Classic Mikasa — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_MIKASA_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _MIKASA_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
