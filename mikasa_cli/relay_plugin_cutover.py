...
RELAY_PLUGINS_CONFIG_ENV = "mikasa_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "mikasa_NEMO_RELAY_ATOF_ENABLED",
    "mikasa_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "mikasa_NEMO_RELAY_ATOF_FILENAME",
    "mikasa_NEMO_RELAY_ATOF_MODE",
    "mikasa_NEMO_RELAY_ATIF_ENABLED",
    "mikasa_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "mikasa_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "mikasa_NEMO_RELAY_ATIF_AGENT_NAME",
    "mikasa_NEMO_RELAY_ATIF_AGENT_VERSION",
    "mikasa_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "mikasa_NEMO_RELAY_ATIF_MODEL_NAME",
    "mikasa_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
