...
there at call time (``_m.<name>``) so ``patch("mikasa_cli.models.<name>")`` mocks keep intercepting;
...
def _validate_lmstudio(req: _Request) -> dict[str, Any]:
    from mikasa_cli import models_local as _ml
...
def _ollama_probe_headers(req: _Request) -> dict[str, str]:
    ...
    from mikasa_cli import models as _m
    from mikasa_cli import models_local as _ml
    from mikasa_cli.models_local import _configured_ollama_base_url, _drop_authorization
