...
from mikasa_cli.colors import Colors
from mikasa_cli.cli_output import prompt_yes_no
from mikasa_cli.curses_ui import curses_single_select
from mikasa_cli.mcp_catalog import (
...
def _configure_tools(name: str) -> None:
    ...
    from mikasa_cli.mcp_config import cmd_mcp_configure
