...
from mikasa_cli.pty_session import RegistryFull
from mikasa_cli.web_deps import LateState, late
from mikasa_cli.web_server_chat import (
...
_active_session_file_for_channel = late("_active_session_file_for_channel", "mikasa_cli.web_server_chat")
_profile_scope = late("_profile_scope", "mikasa_cli.web_server_profiles")
_resolve_chat_argv_async = late("_resolve_chat_argv_async", "mikasa_cli.web_server_chat")
_resolve_profile_dir = late("_resolve_profile_dir", "mikasa_cli.web_server_profiles")
_ws_auth_reason = late("_ws_auth_reason", "mikasa_cli.web_server_chat")
_ws_client_reason = late("_ws_client_reason", "mikasa_cli.web_server_chat")
_ws_host_origin_reason = late("_ws_host_origin_reason", "mikasa_cli.web_server_chat")
...
def _ws_auth_mode() -> str:
    ...
    from mikasa_cli.web_server_chat import _LOOPBACK_HOSTS
...
async def console_ws(ws: WebSocket) -> None:
    ...
    try:
        from mikasa_cli.console_engine import HermesConsoleEngine
...
async def pty_ws(ws: WebSocket) -> None:
    from mikasa_cli.web_server_chat import PTY_REGISTRY, PtyBridge, PtyUnavailableError, _PTY_BRIDGE_AVAILABLE, _RESIZE_RE
    ...
    if raw_resume and env:
        registry_resume = env.get("mikasa_TUI_RESUME") or raw_resume
