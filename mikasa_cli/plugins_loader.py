...
from mikasa_constants import get_mikasa_home, reset_mikasa_home_override, set_mikasa_home_override
from registration_lifecycle import replacement_coordinator
from mikasa_cli.plugins_discovery import ENTRY_POINTS_GROUP, _select_entry_point_group
from mikasa_cli.plugins_manifest import PluginManifest, manifest_key, validate_config_schema
from mikasa_cli.plugins_state import _plugin_settings_entry

if TYPE_CHECKING:  # pragma: no cover
    from mikasa_cli.plugins import LoadedPlugin

logger = logging.getLogger("mikasa_cli.plugins")

_NS_PARENT = "mikasa_plugins"
...
class PluginLoaderMixin:
    ...
    def _register_deferred_platform_tools(self, manifest: PluginManifest, loaded: LoadedPlugin) -> None:
        ...
        """
        from mikasa_cli.plugins import PluginContext, _PLUGINS_DEBUG
    ...
    def _load_plugin_scoped(self, manifest: PluginManifest) -> None:
        ...
        from mikasa_cli.plugins import LoadedPlugin, PluginContext, _PLUGINS_DEBUG
        ...
        from mikasa_cli.plugin_compat import disable_reason
    ...
    def _track_tool_override_policy(self, manifest: PluginManifest, module_name: str) -> None:
        ...
        from mikasa_cli.plugins import PluginContext
    ...
    def _load_portable_plugin(self, manifest: PluginManifest, loaded: LoadedPlugin) -> None:
        ...
        lookup_key = manifest_key(manifest)
        try:
            from mikasa_cli.agent_plugins import load_agent_plugin
            package = load_agent_plugin(
                Path(manifest.path), get_mikasa_home() / "plugin-data" / manifest.skill_namespace)
