...
def _(rid, params: dict) -> dict:
    from mikasa_cli.input_sanitize import sanitize_user_prompt_text
...
def _(rid, params: dict) -> dict:
    ...
    if err:
        return err
    try:
        from mikasa_cli.clipboard import has_clipboard_image, save_clipboard_image
...
def _spawn_side_agent(
    ...
    def run():
        ...
        # Bug #50233: ephemeral agent threads don't inherit the session's MIKASA_HOME override (the
        ...
        # Bug #50233: ephemeral preview-restart agent threads don't inherit the session's MIKASA_HOME
