...
def resolve_skin() -> dict:
    try:
        from mikasa_cli.skin_engine import init_skin_from_config, get_active_skin
...
def _watcher_home() -> Path:
    ...
    return Path(override if isinstance(override, str) and override else _mikasa_home)
