...
_WATCHDOG_POLL_S = max(0.05, env_float("mikasa_SLASH_WATCHDOG_POLL_S", 2.0))
_ORPHAN_GRACE_S = max(0.0, env_float("mikasa_SLASH_WATCHDOG_GRACE_S", 5.0))
...
def _prepare_slash_worker_runtime() -> None:
    ...
    See #61891.
    """
    from mikasa_cli.mcp_startup import start_background_mcp_discovery, wait_for_mcp_discovery
...
def main():
    ...
    args = p.parse_args()
    os.environ["mikasa_SESSION_KEY"] = args.session_key
