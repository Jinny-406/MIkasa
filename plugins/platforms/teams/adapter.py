...
class TeamsAdapter(BasePlatformAdapter):
    ...
    async def _on_card_action(
        ...
        hermes_action = data.get("mikasa_action", "")
    ...
    async def send_exec_approval(
        ...
        def _action(title: str, hermes_action: str, **kw) -> "ExecuteAction":
            return ExecuteAction(
                title=title, verb="mikasa_approve", data={**btn_data_base, "mikasa_action": hermes_action}, **kw)
...
def interactive_setup() -> None:
    ...
    from mikasa_cli.cli_output import prompt, prompt_yes_no, print_info, print_success, print_warning
