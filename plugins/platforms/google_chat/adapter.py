...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        try:
            from mikasa_constants import get_mikasa_home as _get_mikasa_home
            _mikasa_home = _get_mikasa_home()
        except (ModuleNotFoundError, ImportError):
            _mikasa_home = _Path.home() / ".hermes"
        self._thread_count_store = _ThreadCountStore(_mikasa_home / "google_chat_thread_counts.json")
    ...
    def _bot_id_cache_path(self) -> _Path:
        ...
        from mikasa_constants import get_mikasa_home as _get_mikasa_home
        return _get_mikasa_home() / "google_chat_bot_id.json"
    ...
    async def send_clarify(
        ...
        def _button(text: str, choice: str) -> Dict[str, Any]:
            return {"text": text, "action": "mikasa_clarify", "parameters": {"clarify_id": clarify_id, "choice": choice}}
...
def interactive_setup() -> None:
    ...
    from mikasa_cli.cli_output import print_info, print_success, print_warning, prompt, prompt_yes_no
