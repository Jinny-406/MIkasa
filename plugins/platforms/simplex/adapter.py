...
class SimplexAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig, **kwargs):
        ...
        self._text_batch_delay = float(os.getenv("mikasa_SIMPLEX_TEXT_BATCH_DELAY", "0.8"))
...
def interactive_setup() -> None:
    ...
    try:
        ...
        print("mikasa_cli.config not available; set SIMPLEX_* vars manually in ~/.hermes/.env")
        return
