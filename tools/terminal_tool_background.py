...
_ROUTING_FIELDS = (
    ("watcher_chat_id", "mikasa_SESSION_CHAT_ID"),
    ("watcher_user_id", "mikasa_SESSION_USER_ID"),
    ("watcher_user_name", "mikasa_SESSION_USER_NAME"),
    ("watcher_thread_id", "mikasa_SESSION_THREAD_ID"),
    ("watcher_message_id", "mikasa_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "mikasa_SESSION_ID"),
)
