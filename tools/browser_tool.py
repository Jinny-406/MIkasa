...
from mikasa_cli.config import DEFAULT_CONFIG, cfg_get
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        if not cfg_get(read_raw_config(), "browser", "record_sessions", default=False):
            return
        recordings_dir = MIKASA_HOME / "browser_recordings"
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> Union[str, Dict[str, Any]]:
    ...
    screenshots_dir = get_mikasa_dir("cache/screenshots", "browser_screenshots")
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'get_mikasa_home_override': ('mikasa_constants', 'get_mikasa_home_override'),
    'mikasa_home_key': ('mikasa_constants', 'mikasa_home_key'),
    ...
    'node_tool_runnable': ('mikasa_constants', 'node_tool_runnable'),
