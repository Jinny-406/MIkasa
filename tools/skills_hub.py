...
_skills_dir = _path_resolver("SKILLS_DIR", "mikasa_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"mikasa_HOME": _mikasa_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'mikasa_INDEX_TTL': ('tools.skills_hub_search', 'mikasa_INDEX_TTL'),
    'mikasa_INDEX_URL': ('tools.skills_hub_search', 'mikasa_INDEX_URL'),
