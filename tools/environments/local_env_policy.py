...
_STATIC_PROVIDER_ENV_BLOCKLIST = frozenset({
    ...
    "EMAIL_HOME_ADDRESS", "EMAIL_HOME_ADDRESS_NAME", "mikasa_DASHBOARD_SESSION_TOKEN",
...
def _buzz_terminal_context_active() -> bool:
    ...
    try:
        ...
        return get_session_env("mikasa_SESSION_PLATFORM", "").strip().lower() == "buzz"
    except Exception:
        return False
...
_ALWAYS_STRIP_KEYS: frozenset[str] = frozenset({
    ...
    "HASS_TOKEN", "EMAIL_PASSWORD", "mikasa_DASHBOARD_SESSION_TOKEN",
