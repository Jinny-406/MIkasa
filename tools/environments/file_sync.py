...
_FORCE_SYNC_ENV = "mikasa_FORCE_FILE_SYNC"
...
class FileSyncManager:
    ...
    def sync_back(self, MIKASA_HOME: Path | None = None) -> None:
        ...
        with self._transaction_lock:
            self._sync_back_transaction(MIKASA_HOME=MIKASA_HOME)

    def _sync_back_transaction(self, MIKASA_HOME: Path | None = None) -> None:
        ...
        lock_path = (MIKASA_HOME or get_mikasa_home()) / ".sync.lock"
