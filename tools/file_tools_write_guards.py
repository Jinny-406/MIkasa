...
_real_mikasa_home_cached: str | None = None
_real_mikasa_home_loaded = False
...
def _mikasa_home_real() -> str:
    from mikasa_constants import get_mikasa_home
    return os.path.realpath(str(get_mikasa_home()))
...
def _get_real_mikasa_home() -> str | None:
    """Return the realpath of the authoritative Hermes home (cached)."""
    return _cached_lookup("_real_mikasa_home_cached", "_real_mikasa_home_loaded", _mikasa_home_real,
...
def _protected_instruction_reason(filepath: str, task_id: str = "default",
    ...
    real_home = _get_real_mikasa_home()
