...
def _session_owner_scope(task_id: str):
    ...
    home_token = set_mikasa_home_override(owner_home)
    try:
...
def _update_session_activity(task_id: str):
    ...
    with _bt._cleanup_lock:
        ...
        _bt._session_owner_homes.setdefault(task_id, str(get_mikasa_home()))
...
def _cleanup_old_recordings(max_age_hours=72):
    ...
    try:
        recordings_dir = get_mikasa_home() / "browser_recordings"
    except Exception as e:
