...
KDIR = os.environ["mikasa_KERNEL_DIR"]
...
def _spawn_remote_kernel(env, env_type: str, owner: str, task_env_id: str,
    ...
    try:
        ...
        env_prefix = (f"mikasa_KERNEL_DIR={q_dir} HERMES_RPC_DIR={shlex.quote(kernel_dir + '/rpc')} "
                      f"mikasa_RPC_TOKEN={shlex.quote(rpc_token)} PYTHONDONTWRITEBYTECODE=1 PYTHONPATH={q_dir}")
