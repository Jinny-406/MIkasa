...
The run gets a throwaway MIKASA_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE MIKASA_HOME is redirected to the
