...
Usage:
  ...
  providers: nous (Portal creds from mikasa_HOME), openrouter (OPENROUTER_API_KEY or --api-key),
...
def creds():
    ...
    from mikasa_cli.auth_nous import resolve_nous_runtime_credentials
