...
#   python cache_prefix_wire.py <repo_root> <A|B> [--hermes-home DIR]   (default MIKASA_HOME: the real one, for credentials)
sys.path.insert(0, sys.argv[1])
os.environ.setdefault("mikasa_HOME", os.path.expanduser("~/.hermes"))
if "--hermes-home" in sys.argv:
    os.environ["mikasa_HOME"] = sys.argv[sys.argv.index("--hermes-home") + 1]
