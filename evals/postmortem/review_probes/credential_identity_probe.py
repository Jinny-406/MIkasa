...
os.environ.update(HOME=str(home), MIKASA_HOME=str(home/'hermes'), XDG_CONFIG_HOME=str(home/'config'), CODEX_HOME=str(home/'codex'))
...
os.environ['mikasa_SHARED_AUTH_DIR']=str(home/'shared')
