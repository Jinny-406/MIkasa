...
For each task: fresh temp MIKASA_HOME, fresh fixture workspace, real
...
def run_task(task, model: str, provider: str, timeout_mult: float,
    ...
    MIKASA_HOME = Path(tempfile.mkdtemp(prefix="readtool-home-")) / ".hermes"
    ...
    try:
        ...
        shutil.rmtree(MIKASA_HOME.parent, ignore_errors=True)
    return result
