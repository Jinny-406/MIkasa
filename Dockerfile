...
# ---------- Runtime ----------
ENV MIKASA_WEB_DIST=/opt/hermes/hermes_cli/web_dist
ENV MIKASA_TUI_DIR=/opt/hermes/ui-tui
ENV MIKASA_HOME=/opt/data
ENV MIKASA_WRITE_SAFE_ROOT=/opt/data
ENV MIKASA_DISABLE_LAZY_INSTALLS=1
ENV MIKASA_LAZY_INSTALL_TARGET=/opt/data/lazy-packages
